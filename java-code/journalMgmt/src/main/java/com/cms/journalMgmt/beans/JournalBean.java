...
public class JournalBean {
	...
	public String toString() {
		return "JournalBean [journalName=" + journalName + ", journalShortName=" + journalShortName + ", journalEmail="
				+ journalEmail + ", issnNumber=" + issnNumber + ", ispnNumber=" + ispnNumber + ", aboutJournal="
				+ aboutJournal + ", aimAndScope=" + aimAndScope + ", articleInPressText=" + articleInPressText
				+ ", currentIssueText=" + currentIssueText + ", archievePageText=" + archievePageText + ", guidlines="
				+ guidlines + ", articleProcessingCharge=" + articleProcessingCharge + ", journalBanner="
				+ journalBanner + ", journalFlier=" + journalFlier + ", journalPDF=" + journalPDF + ", fbLink=" + fbLink
				+ ", twitterLink=" + twitterLink + ", linkedinLink=" + linkedinLink + ", journalPrimaryAdmin="
				+ journalPrimaryAdmin + ", journalSecondaryAdmin=" + journalSecondaryAdmin + ", reviewStatus="
				+ reviewStatus + ", journalStatus=" + journalStatus + "]";
	}
