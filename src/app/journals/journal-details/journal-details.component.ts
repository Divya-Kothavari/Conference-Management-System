...
export class JournalDetailsComponent {
    ...
    ngOnInit(): void {
        ...
        this.uploadPdfFlyer = `http://cmsservices-dev.cvqprwnpp8.us-east-2.elasticbeanstalk.com/cmsjournalmgmt/journalPDF/${this.journalid}`;
        this.uploadFlyerLogo = `http://cmsservices-dev.cvqprwnpp8.us-east-2.elasticbeanstalk.com/cmsjournalmgmt/journalLogo/${this.journalid}`;
        ...
        this.http.get(`http://cmsservices-dev.cvqprwnpp8.us-east-2.elasticbeanstalk.com/cmsjournalmgmt/journalSubjects/${this.journalid}`).subscribe(
            (resp: any) =>{
                if (resp.status === 'Success') {
    ...
    updateJournal() {
        ...
        this.http.put(`http://cmsservices-dev.cvqprwnpp8.us-east-2.elasticbeanstalk.com/cmsjournalmgmt/journal`, this.journalDetails).subscribe(
            (resp: any) =>{
        ...
        if (this.selectedSubject.length !== 0) {
            ...
            this.http.post(`http://cmsservices-dev.cvqprwnpp8.us-east-2.elasticbeanstalk.com/cmsjournalmgmt/journalSubjects/${this.journalid}/${data}`, {}).subscribe(
                (resp: any) =>{
                    if (resp.status === 'Success') {
                        this.message.success(resp.message);
                    }
