...
@Component({
  selector: 'app-journal-submit-manuscript',
  templateUrl: './journal-submit-manuscript.component.html',
  styleUrls: ['./journal-submit-manuscript.component.scss']
})
export class JournalSubmitManuscriptComponent implements OnInit {
